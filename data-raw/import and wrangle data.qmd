...
dataset <- read.csv(here::here("ukb_h", "data-raw", "table-exporter_2025-03-17_09-32-33_data.csv")) 
```
...
```{r}
# icd10to9 <- read.csv(here::here("ukb_h", "data/icd10toicd9.csv"), quote = "") %>%
icd10to9 <- read.csv(here::here("https://data.nber.org/gem/icd10cmtoicd9gem.csv"), quote = "") %>%
...
```{r}
# ascvd_data <- read.csv(here::here("cvd_obesity_diabetes_ukbrap/data-raw/ascvd_col.csv")) %>% 
